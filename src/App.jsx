  ...
  return (
    <div className="font-sans antialiased text-gray-900 bg-gray-50 relative">
      ...
      <main>
        ...
        <BrandsCarousel />
        <Testimonials />
        <WhatsAppForm initialService={selectedService} />
      </main>
      <Footer />

      {/* --- BOTÃO FLUTUANTE QUE LEVA AO FORMULÁRIO --- */}
      <button
      ...
      >
        ...
        {/* Tooltip informativo */}
        <span className="absolute right-full mr-4 bg-white text-gray-800 px-4 py-2 rounded-lg shadow-md text-sm font-bold opacity-0 group-hover:opacity-100 transition-opacity duration-300 whitespace-nowrap hidden md:block pointer-events-none">
          Solicitar Orçamento
        </span>
      </button>
